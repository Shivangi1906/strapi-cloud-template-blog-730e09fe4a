...
export interface ApiAffiliateCountryAffiliateCountry
  extends Struct.CollectionTypeSchema {
  collectionName: 'affiliate_countries';
  info: {
    displayName: 'Affiliate Country';
    pluralName: 'affiliate-countries';
    singularName: 'affiliate-country';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    affiliates: Schema.Attribute.Relation<
      'oneToMany',
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::affiliate-country.affiliate-country'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAffiliateAffiliate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    affiliate_country: Schema.Attribute.Relation<
      'manyToOne',
      'api::affiliate-country.affiliate-country'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imdbLink: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::project.project'
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    writer: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::affiliate-country.affiliate-country': ApiAffiliateCountryAffiliateCountry;
